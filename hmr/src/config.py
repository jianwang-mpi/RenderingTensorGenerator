...
flags.DEFINE_string('PRETRAINED_MODEL', PRETRAINED_MODEL,
...
# Training settings:
#  If you want to train, change this to your 'tf_datasets' or specify it with the flag.
DATA_DIR = '/unsullied/sharefs/wangjian02/isilon-home/datasets/hmr_tf_dataset'

flags.DEFINE_string('data_dir', DATA_DIR, 'Where to save training models')
flags.DEFINE_string('log_dir', '/unsullied/sharefs/wangjian02/isilon-home/logs/hmr', 'Where to save training models')
